...
- Keep intermediate iterations and numerical tables.
- State the method, stopping condition, precision, and input data.
- Verify the requested output format from the current task.
